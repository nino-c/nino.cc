...
Polygon.prototype.getAestheticRotation = function() {
	var r;
	switch (this.n) {
		case 3:
		case 4:
		case 5:
		case 7:
			r = this.n % 2 ? Math.PI / 2 : Math.PI / 4;
		break;
		case 8:
			r = Math.PI / this.n;
		break;
...
Polygon.prototype.getVertices = function() {
    for (var i=0; i<this.n; i++) {
        ...
        // if polygon should point 'upwards', rotate
        if (this.pointUpwards) {
        	var dtheta = this.getAestheticRotation();
        	theta -= dtheta;
        }
    ...
    this.axis = [ 
    	[(this.radius * -1.5), 0], [(this.radius * 1.5), 0],
